...
public class MoreView extends Activity  {
	...
	public void populate(){
		...
		loadImage(im1,recomendedArray.get(0));
		loadImage(im2,recomendedArray.get(1));
		loadImage(im3,recomendedArray.get(2));
		loadImage(im4,recomendedArray.get(3));
		loadImage(im5,recomendedArray.get(4));
		loadImage(im6,recomendedArray.get(5));
		loadImage(im7,recomendedArray.get(6));
		loadImage(im8,recomendedArray.get(7));
	...
	private Context context = MoreView.this; 
	ImageAsyncLoader asyncImageLoader = new ImageAsyncLoader();  
    private void loadImage(final ImageView image, final String imageUrl) {  
...
class ImageAsyncLoader
{
    ...
    public ImageAsyncLoader() {  
         ...
         */  
        executor = new ThreadPoolExecutor(2, 10, 100, TimeUnit.SECONDS, queue);  
    }  
    ...
    public  Drawable loadImageFromUrl(Context context, String imageUrl) {  
